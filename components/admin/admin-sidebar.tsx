...
export function AdminSidebar() {
  ...
  return (
    <aside className="card h-fit p-4 md:sticky md:top-20">
      ...
      <form action={signOutAction} className="mt-4 border-t border-mocha/10 pt-4 dark:border-white/10">
        <button type="submit" className="w-full rounded-xl border border-mocha/20 px-3 py-2 text-sm hover:bg-white dark:border-white/20 dark:text-white/80 dark:hover:bg-white/10">
          Đăng xuất
        </button>
      </form>
    </aside>
