  ...
  return (
    <button
      className={cn(
        ...
        variant === "outline-solid" && "border border-mocha/20 bg-white text-mocha hover:border-mocha/40 dark:border-white/20 dark:bg-white/5 dark:text-white/80 dark:hover:bg-white/10",
        className
      )}
      {...props}
    />
